"""khadam_19702 URL Configuration
...
admin.site.site_header = "khadam"
admin.site.site_title = "khadam Admin Portal"
admin.site.index_title = "khadam Admin"

# swagger
api_info = openapi.Info(
    title="khadam API",
    default_version="v1",
    description="API documentation for khadam App",
)
